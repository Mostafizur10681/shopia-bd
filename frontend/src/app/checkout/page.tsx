...
export default function CheckoutPage() {
  ...
  const [paymentMethod, setPaymentMethod] = useState<"bank" | "bkash" | "cod">("bank");
  ...
  const handlePlaceOrder = (e: React.FormEvent) => {
    ...
    if (!email || !firstName || !streetAddress1 || !townCity || !district || !phone) {
      showToast("Please fill in all required billing fields marked with *");
      return;
    }
